...
export default function StudentWorkspace({
  ...
  const initialProject = cs.inPersonalSandbox
    ? null
    : () =>
        selectScratchInitialProject({
          tasks: lesson.tasks,
  ...
  const { predefinedBlocks, prebuiltStacks } = useMemo(
    () =>
      selectScratchToolboxSnippets({
        task,
  ...
  const externalState = useMemo(() => {
    ...
    displayCode,
    isSandbox,
    cs.scratchSandboxProject,
    cs.inPersonalSandbox,
    personalSandboxScratchState,
    cs.scratchExternalState,
  ])
