...
export default function BuilderWorkspace({ task, lesson, onUpdate, codeTab, codeStages, activePythonCode, handleCodeTabChange, handleAddStage, handleRemoveStage, resetToStarterBtn }) {
  ...
  return <div style={s.wrap}>
    <div className="te-code-workspace-stack" style={{ minHeight: 300, gridColumn: isSupportStage ? '1 / -1' : undefined }}>
      <CodeWorkspaceTabs activeTab={codeTab} onChange={handleCodeTabChange} stages={codeStages} onAddStage={handleAddStage} onRemoveStage={handleRemoveStage} rightAction={resetToStarterBtn} unifiedStages />
