...
// Subject, operators and fields for each canonical filesystem check type. The Desktop
// module's check editor builds its type dropdown and field list from this table.
