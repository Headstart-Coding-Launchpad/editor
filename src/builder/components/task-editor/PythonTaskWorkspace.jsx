      ...
      <div className="te-code-workspace-stack">
        ...
        {isStageTab ? (
          ...
          <div className="te-no-file">
            Add a Starter stage to begin authoring this task. Legacy starter and complete code
            remains available to existing lessons but is no longer edited here.
          </div>
        )}
      </div>
      ...
      {task.interactionMode === 'submit' ? (
        <>
          <div className="te-run-row">
            ...
            {!task.check && (
              <span
                style={{ fontFamily: 'var(--font-body)', fontSize: '0.85rem', color: '#9ca3af' }}
              >
