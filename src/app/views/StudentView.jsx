...
export default function StudentView({ lessonId: lessonIdProp, soloMode = false, lesson: lessonProp = null, teacherPresentation = false, allowUnrestrictedTaskNavigation = false, previewMode = false, initialTaskId = null, onTaskChange = null }) {
  ...
  const {
    ...
    writeStudentRun, logAttempt, writeStudentAnswer, writeStudentCode, writeStudentFiles, writeStudentOutput, writeStudentInteraction, recordStudentCarryFallback, writeStudentPersonalSandbox, writeStudentPresence,
  ...
  const cs = useStudentCodeState({
    ...
    writeStudentInteraction, recordStudentCarryFallback, writeStudentPersonalSandbox, writeStudentPresence,
