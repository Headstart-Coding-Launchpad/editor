      ...
      <div style={s.left}>
        {!isMobile && (
          <span style={s.logo}>
            ...
            >
              <g
                transform="translate(256 256) rotate(45) scale(1.14) translate(-256 -256)"
                fill="#ffffff"
              >
                <path
                  d="M256 38C306 82 333 143 325 202C320 239 304 272 283 301L272 355C270 367 262 378 256 378C250 378 242 367 240 355L229 301C208 272 192 239 187 202C179 143 206 82 256 38ZM256 125C236 125 220 141 220 161C220 181 236 197 256 197C276 197 292 181 292 161C292 141 276 125 256 125Z"
                  fillRule="evenodd"
                />
        ...
        {!isSandbox &&
          (isMobile ? (
            ...
            <>
              {isSolo === true && (
                <span style={{ ...s.modeBadge, background: '#6b7280' }}>SOLO</span>
              )}
              {isSolo === false && (
                <span style={{ ...s.modeBadge, background: '#22c55e' }}>LIVE</span>
              )}
            </>
          ))}
      </div>
