...
Full JSON field reference for cross-cutting fields. For YAML authoring see `docs/authoring/AUTHORING_GUIDE.md`. For type-specific code task fields and minimal examples see `docs/authoring/{python,html,scratch,filesystem}.md`.
