...
- `docs/authoring/lesson-schema.md`, `docs/authoring/quiz-tasks.md`, or the relevant per-type doc (`docs/authoring/{python,html,scratch,filesystem}.md`) when lesson JSON fields or check types change.
