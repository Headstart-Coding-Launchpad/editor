...
| Scratch | Drag-and-drop block programming with a live stage canvas; costume and sprite dropdowns (switch costume, go to, glide, touching, distance to, create clone of) show a thumbnail preview of each option |
